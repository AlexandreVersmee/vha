...
<header class="header">
    ...
    <div class="row">
        ...
        <div class="hide-for-small-only medium-2 columns">
            <img src="images/Specialisation_Entreprise_Flotte.jpg" alt="Spécialité  de l'assurance Versmée & Hautcoeur" >
            <img src="images/Specialisation_Construction_Collectives.jpg" alt="Spécialité de l'assurance Versmée & Hautcoeur" >
        </div>
    </div>
    ...
    <ul class="header-subnav show-for-medium">
        ...
        <li><a id="header-link-agences" href="nos_agences.php" tabindex=2><span class="show-for-large">Nos</span> Agences  |  </a></li>
        <li><a id="header-link-expertise" href="notre_expertise.php" tabindex=3>Notre Expertise   |  </a></li>
        <li><a id="header-link-equipe" href="notre_equipe.php" tabindex=4><span class="show-for-large">Notre</span> Equipe  |  </a></li>
